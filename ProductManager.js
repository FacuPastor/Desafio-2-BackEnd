    ...
    async addProduct(title, description, price, thumbnail, code, stock){
        try{
            ...
            if(title != "" && description != "" && price != null && thumbnail != "" && code != ""){
                ...
                console.log("Faltante de informacion para agregar el producto");
            }
        }catch(error){
            console.log(error);
        }
...
productos.addProduct('producto1', 'probando', 3500, 'Sin imagen', 'prod123', 12).then((res) => console.log(res));

productos.getProductById(1).then(res => console.log(res));

productos.getProductById(2).then(res => console.log(res));

productos.updateProduct(1, 'update producto prueba', 'probando', 3500, 'Sin imagen', 'prod123', 12).then(()=> productos.getProducts().then((res) => console.log(res)));

productos.addProduct('producto prueba', 'probando', 3500, 'Sin imagen', 'prod1234', 9).then((res) => console.log(res));
